...
const DEFAULT = { arrivalThreshold: 0.15, stuckMovementEpsilon: 0.015, stuckTimeoutMs: 550 };
function resolveDir(route, target, currentX, currentZ, cfg = DEFAULT) {
    const r = [...route];
    while (r.length > 0) {
        const next = r[0];
...
function calcStuck(prevStuckMs, prevX, prevZ, currentX, currentZ, delta, cfg = DEFAULT) {
...
//# sourceMappingURL=useClickToMoveController.test.js.map