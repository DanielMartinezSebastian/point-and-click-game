...
import { clearRegistry, registerDictionaries, registerDictionary, } from "../game/i18n/registry";
import { getRandomPhrase, matchLocale, translate, } from "../game/i18n/translator";
...
describe("getRandomPhrase", () => {
    ...
    it("interpolates vars in the picked phrase", () => {
        ...
        expect(getRandomPhrase("greet", { random: () => 0, vars: { name: "Ana" } })).toBe("Hola Ana");
    });
});
...
//# sourceMappingURL=i18nTranslator.test.js.map